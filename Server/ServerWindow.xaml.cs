...
namespace Server
{
    ...
    public partial class ServerWindow : Window, IAutoNotifyPropertyChanged, IClientMessageRecievedHandler
    {
        ...
        private void InitializeMap()
        {
            ...
            topBase.ControllingPlayer = _player0.ID;
            ...
            bottomBase.ControllingPlayer = _player1.ID;
        ...
        private void ApplyNodeIncome()
        {
            ...
            {
                if (node.ControllingPlayer == -1)
                {
                    continue;
                }

                var incomeRate = node.ControllingPlayer == _player0.ID
                    ? _player0.IncomeRate
                    : _player1.IncomeRate;
                node.ApplyIncome(incomeRate);
            }
        }
